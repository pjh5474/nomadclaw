/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 76d799397298d316a0981be74d4a0963)
// Runtime types generated with workerd@1.20260908.1 2026-05-15 nodejs_compat
interface __BaseEnv_Env {
	AI: Ai;
	API_TOKEN: string;
	ACCOUNT_ID: string;
	DebateArena: DurableObjectNamespace<import("./worker/index").DebateArena>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker/index");
		durableNamespaces: "DebateArena";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "API_TOKEN" | "ACCOUNT_ID">> {}
}
