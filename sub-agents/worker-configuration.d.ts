/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 7f302106d2ed792cf1d23d16f9d6bcba)
// Runtime types generated with workerd@1.20260908.1 2026-05-15 nodejs_compat
interface __BaseEnv_Env {
	AI: Ai;
	API_TOKEN: string;
	ACCOUNT_ID: string;
	Orchestrator: DurableObjectNamespace<import("./worker/index").Orchestrator>;
}
