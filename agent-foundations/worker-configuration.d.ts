/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 070aeec126aaaecc15d7e6b8342e18b3)
// Runtime types generated with workerd@1.20260828.1 2026-05-14 nodejs_compat
interface __BaseEnv_Env {
	ChattingRoomAgent: DurableObjectNamespace<import("./worker/index").ChattingRoomAgent>;
	RoomDirectoryAgent: DurableObjectNamespace<import("./worker/index").RoomDirectoryAgent>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker/index");
		durableNamespaces: "ChattingRoomAgent" | "RoomDirectoryAgent";
	}
