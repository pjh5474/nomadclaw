/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 33442de07ee0b1fa89119a9ae966de6f)
...
interface __BaseEnv_Env {
	...
	API_TOKEN: string;
	ACCOUNT_ID: string;
	WebDetectiveAgent: DurableObjectNamespace<import("./worker/index").WebDetectiveAgent>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker/index");
		durableNamespaces: "WebDetectiveAgent";
	}
