/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: b08c40f8b765a70628f7e6b95f063ecb)
// Runtime types generated with workerd@1.20260831.1 2026-05-15 nodejs_compat
interface __BaseEnv_Env {
	FILES: R2Bucket;
	LOADER: WorkerLoader;
	BROWSER: BrowserRun;
	AI: Ai;
	BrowserAgent: DurableObjectNamespace<import("./worker/index").BrowserAgent>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker/index");
		durableNamespaces: "BrowserAgent";
	}
