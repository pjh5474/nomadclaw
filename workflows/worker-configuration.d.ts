/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: aa44bb48b1443c91aaef15464f8ddace)
// Runtime types generated with workerd@1.20260908.1 2026-05-18 nodejs_compat
interface __BaseEnv_Env {
	RestaurantAgent: DurableObjectNamespace<import("./worker/index").RestaurantAgent>;
	PIZZA_WORKFLOW: Workflow<Parameters<import("./worker/index").PizzaWorkflow['run']>[0]['payload']>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker/index");
		durableNamespaces: "RestaurantAgent";
	}
